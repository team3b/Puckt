(function(window) {
	function Puck() {
        ...
        this.view.graphics.beginFill("#222222").drawCircle(300, (880/8)*7, 50);
        // Set scale
        this.view.scaleX = this.view.scaleY = this.view.scale = 0.5;
        ...
        fixtureDef.shape = new box2d.b2CircleShape(50);
        // Create shape's body
